<script setup>
// import { DotsHorizontalIcon } from "@heroicons/vue/24/outline";
  ...
  <div>
    <div class="flex items-center justify-between px-3 py-2">
      ...
      <Menu as="div" class="relative z-10">
        <MenuButton
          class="grid w-8 h-8 rounded-md place-content-center hover:bg-gray-300"
        >
        ...
        >
          <MenuItems
            class="absolute left-0 w-40 mt-2 overflow-hidden origin-top-left bg-white border rounded-md shadow-lg focus:outline-none"
          >
